window.CONTENT_HUB_PUBLIC_CONFIG = {
  supabaseUrl: 'https://oepehanwmfelowfumkes.supabase.co',
  supabaseAnonKey:
  ...
  supabaseFunctionsUrl: 'https://oepehanwmfelowfumkes.supabase.co/functions/v1',
  contentMediaUploadsEnabled: false,
};
